...
const nightmares = [
  ...
  },
  {
    ...
    description: "When dreams become an inescapable reality"
  }
];
      ...
      >
        ...
        >
          <Link href="/" className="group flex items-center text-gray-400 hover:text-red-500 transition-colors duration-300">
            ...
            <span className="text-sm group-hover:underline">Escape the Nightmare</span>
          </Link>
        </motion.div>
        ...
        >
          Where your darkest dreams manifest into tangible terror.
        </motion.p>
        ...
        >
          <p className="text-red-500 text-sm italic">
            "In your dreams, we are always waiting..."
          </p>
        </motion.div>
