...
const contactInfo = [
  {
    platform: "Email",
    value: "krisoprasebenhaezer@gmail.com",
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
      </svg>
    ),
    href: "mailto:krisoprasebenhaezer@gmail.com"
  },
  {
    platform: "WhatsApp",
    value: "+6282213125287",
    ...
    href: "https://wa.me/6282213125287"
  },
  {
    platform: "Instagram",
    value: "krisopras_eben",
    icon: (
      <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
    ...
    href: "https://instagram.com/krisopras_eben"
  }
];
      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="text-xl text-gray-400">
            Step into the shadows and reach out to us through these channels
          </p>
        </motion.div>
        ...
        <div className="grid gap-8 md:grid-cols-1 max-w-2xl mx-auto">
          {contactInfo.map((contact, index) => (
            <motion.a
              ...
              className="group block bg-gray-900 rounded-lg p-6 hover:bg-gray-800 transition-all duration-300"
            >
